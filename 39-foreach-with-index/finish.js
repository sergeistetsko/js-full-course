...
function cityInfo (country, index) {
    return `${country} is at the index ${index} in the myCities array`
}

myCities.forEach((country, index) => {
    const result = cityInfo(country, index)
    console.log(result)
})